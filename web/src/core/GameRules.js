...
export const GameRules = Object.freeze({
  ...
  RelicChoiceCount: 3,
  RewardQualityRelicChoiceMax: 5,
  RewardQualityRelicChoiceActBonus: Object.freeze({
    1: 0,
    2: 0,
    3: 1,
    4: 1,
  }),
  RewardQualityRelicChoiceTypeBonus: Object.freeze({
    [EncounterType.Dungeon]: 0,
    [EncounterType.RivalGhost]: 0,
    [EncounterType.FinalBoss]: 1,
  }),
  RewardQualityShopSilverChanceMax: 0.3,
  RewardQualityShopSilverChanceActBonus: Object.freeze({
    1: 0,
    2: 0.02,
    3: 0.04,
    4: 0.06,
  }),
  RewardQualityShopSilverChanceTypeBonus: Object.freeze({
    [EncounterType.Dungeon]: 0,
    [EncounterType.RivalGhost]: 0.03,
    [EncounterType.FinalBoss]: 0.05,
  }),
  ...
  RushAheadMoraleCost: 2,
  BribeGuideGoldCost: 4,
  BribeGuideDebtFallback: 3,
